...
public class SwitchView extends View {
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        final int DEFAULT_COLOR_PRIMARY = 0xFFFF7554;
        ...
        colorOff = a.getColor(R.styleable.SwitchView_closeColor, 0xFFE3E3E3);
        colorOffDark = a.getColor(R.styleable.SwitchView_closeColorDark, 0xFFBFBFBF);
    ...
    private static final class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SwitchView.SavedState>() {
            @Override
            public SwitchView.SavedState createFromParcel(Parcel in) {
                return new SwitchView.SavedState(in);
            }

            @Override
            public SwitchView.SavedState[] newArray(int size) {
                return new SwitchView.SavedState[size];
            }
        };
    }
}
