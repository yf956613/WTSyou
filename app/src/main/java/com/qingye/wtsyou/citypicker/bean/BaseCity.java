package com.qingye.wtsyou.citypicker.bean;
 ...
 */
public class BaseCity implements Parcelable,Serializable
{
    /**
     *  城市code(baidu)
     */
    ...
    public static final Creator<BaseCity> CREATOR = new Creator<BaseCity>()
    {
        @Override
