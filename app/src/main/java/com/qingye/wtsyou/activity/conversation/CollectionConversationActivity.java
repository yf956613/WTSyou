...
public class CollectionConversationActivity extends BaseHttpRecyclerActivity<Conversation,ConversationHotView,ConversationHotAdapter> implements View.OnClickListener,OnBottomDragListener {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, CollectionConversationActivity.class);
    }
