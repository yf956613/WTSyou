...
public class HeartActivity extends BaseHttpRecyclerActivity<HeartDetailed,HeartDetailedView,HeartDetailedAdapter>
        implements View.OnClickListener, View.OnLongClickListener, OnBottomDragListener, OnHttpPageCallBack<EntityPageData, HeartDetailed> {
    ...
    private HttpPageModel<EntityPageData, HeartDetailed> mEntityPageDataHttpModel;

    private int heartCount;
    List<HeartDetailed> heartDetailedList = new ArrayList<>();
    ...
    @Override
    public void setList(final List<HeartDetailed> list) {
    ...
    public void initData() {
        ...
        tvValue.setText(Integer.toString(heartCount));
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.iv_left:
                ...
                break;
            case R.id.iv_right:
                toActivity(RuleActivity.createIntent(context, "love", "爱心规则"));
                break;
            default:
                break;
        }
    ...
    public void getHeartDetailed() {
        setProgressBar();
        progressBar.show();

        //明星列表
        mEntityPageDataHttpModel.refreshPost(URL_BASE + URLConstant.HEARTQUERY, this);
    }
    ...
    @Override
    public List<HeartDetailed> getList(EntityPageData data) {
        return GsonUtil.getGson().fromJson(GsonUtil.getGson().toJson(data.getContent().getData())
                ,new TypeToken<List<HeartDetailed>>(){}.getType());
    }
    ...
    @Override
    public void refreshSuccessPagingList(List<HeartDetailed> list) {
        heartDetailedList.clear();

        heartDetailedList.addAll(list);
        setList(heartDetailedList);
        srlBaseHttpRecycler.finishRefresh();
    ...
    @Override
    public void loadMoreSuccessPagingList(List<HeartDetailed> list) {
        heartDetailedList.addAll(list);
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        ...
        //爱心列表
        mEntityPageDataHttpModel.loadMorePost(URL_BASE + URLConstant.HEARTQUERY, this);
    }
