...
import com.qingye.wtsyou.fragment.conversation.SearchHistoryConversationFragment;
import com.qingye.wtsyou.fragment.conversation.SearchHotConversationFragment;
import com.qingye.wtsyou.fragment.conversation.SearchRecommendConversationFragment;

import zuo.biao.library.base.BaseActivity;
import zuo.biao.library.interfaces.OnBottomDragListener;

public class SearchConversationActivity extends BaseActivity implements View.OnClickListener, View.OnLongClickListener, OnBottomDragListener {
    ...
    public void initView() {
        ...
        SearchHistoryConversationFragment searchHistoryConversationFragment = new SearchHistoryConversationFragment();
        SearchHotConversationFragment searchHotConversationFragment = new SearchHotConversationFragment();
        ...
        //把碎片添加到碎片中
        transaction.replace(R.id.list_history,searchHistoryConversationFragment);
        transaction.replace(R.id.list_hot_search,searchHotConversationFragment);
