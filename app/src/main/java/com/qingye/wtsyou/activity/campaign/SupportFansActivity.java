...
public class SupportFansActivity extends BaseHttpRecyclerActivity <CrowdFans,CrowdFansView,CrowdFansAdapter>
    ...
    public static Intent createIntent(Context context, String activityId) {
        return new Intent(context,SupportFansActivity.class).putExtra(Constant.ACTIVITYID, activityId);
    }
    ...
    public void crowdFansQuery() {
        ...
        //筹资明细
        mEntityPageDataHttpModel.refreshPost( URL_BASE + URLConstant.SUPPORTFANSDETAILED,this);
    }
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        ...
        //参与列表
        mEntityPageDataHttpModel.loadMorePost(URL_BASE + URLConstant.SUPPORTFANSDETAILED, this);
    }
