...
import com.qingye.wtsyou.fragment.my.MessageOfficialFragment;
import com.qingye.wtsyou.fragment.my.MessageShowFragment;
import com.qingye.wtsyou.fragment.my.MessageTalkFragment;
...
public class MessageActivity extends BaseActivity implements View.OnClickListener, View.OnLongClickListener, OnBottomDragListener {

    private ImageView ivBack;
    private TextView tvHead;

    private ArrayList<Fragment> mFragments = new ArrayList<>();
    private String[] mTitles = {"通知", "演出消息","私信"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragments.add(messageOfficialFragment);
        mFragments.add(messageShowFragment);
        mFragments.add(messageTalkFragment);
