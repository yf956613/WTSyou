...
public class SupportMoneyDetailedActivity extends BaseHttpRecyclerActivity<CrowdMoneyDetailed,CrowdMoneyDetailedView,CrowdMoneyDetailedAdapter>
    ...
    public static Intent createIntent(Context context, String activityId) {
        return new Intent(context, SupportMoneyDetailedActivity.class).putExtra(Constant.ACTIVITYID, activityId);
    }
    ...
    public void moneyDetailedQuery() {
        ...
        //筹资明细
        mEntityPageDataHttpModel.refreshPost(URL_BASE + URLConstant.SUPPORTMONEYDETAILED,this);
    }
    ...
    public void onLoadmore(RefreshLayout refreshlayout) {
        ...
        //参与列表
        mEntityPageDataHttpModel.loadMorePost(URL_BASE + URLConstant.SUPPORTMONEYDETAILED, this);
    }
}
