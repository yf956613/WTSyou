...
import com.qingye.wtsyou.adapter.activity.SelectConversationAdapter;
...
public class SelectStarsConversationActivity extends BaseHttpRecyclerActivity<Conversation,SelectConversationView,SelectConversationAdapter> implements View.OnClickListener,OnBottomDragListener {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, SelectStarsConversationActivity.class);
    }
