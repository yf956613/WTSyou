...
public class RuleActivity extends BaseActivity implements View.OnClickListener, View.OnLongClickListener, OnBottomDragListener {
    ...
    public static Intent createIntent(Context context, String ruleType, String title) {
        return new Intent(context,RuleActivity.class).putExtra(Constant.RULE_TYPE, ruleType).putExtra(Constant.TITLE, title);
    }
    ...
    public void ruleQuery() {
        mEntityRuleHttpModel.get( URL_BASE + URLConstant.RULE + ruleType,1,this);
    }
