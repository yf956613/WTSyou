...
public class SelectOneStarsActivity extends BaseHttpRecyclerActivity <EntityStars,SelectStarsView,SelectStarsAdapter> implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEntityPageDataHttpModel.setPageSize(20);
        allStars();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        selectedStars.add(starsList.get(position));
