...
public class PastStarsChartsDetailedActivity extends BaseHttpRecyclerActivity<StarsCharts,StarsChartsView,StarsChartsAdapter> implements View.OnClickListener, View.OnLongClickListener, OnBottomDragListener {
    ...
    public static Intent createIntent(Context context, long id, int Position) {
        return new Intent(context,PastStarsChartsDetailedActivity.class).putExtra("POSITION",Position);
    }
    ...
    @Override
    public void setList(List<StarsCharts> list) {
