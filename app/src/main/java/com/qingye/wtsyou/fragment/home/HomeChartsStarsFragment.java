 ...
 */
public class HomeChartsStarsFragment extends BaseHttpListFragment<Charts,HomeChartsAdapter> implements CacheCallBack<Charts> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Position = bundle.getInt(HomeChartsStarsFragment.ARGUMENT_POSITION);*/
