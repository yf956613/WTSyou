 ...
 */
public class FansMainActivityFragment extends BaseHttpRecyclerFragment<Campaign,ActivityOfficialView,ActivityOfficialAdapter> implements CacheCallBack<Campaign> {
     ...
     * @return
     */
    public static FansMainActivityFragment createInstance() {

        return new FansMainActivityFragment();
    }

    public FansMainActivityFragment() {
