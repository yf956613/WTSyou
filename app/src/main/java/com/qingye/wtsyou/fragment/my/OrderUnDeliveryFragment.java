...
public class OrderUnDeliveryFragment extends BaseHttpRecyclerFragment<OrderDetailed,OrderDetailedView,OrderDetailedAdapter> implements CacheCallBack<OrderDetailed> {
