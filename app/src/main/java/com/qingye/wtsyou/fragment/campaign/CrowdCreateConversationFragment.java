...
public class CrowdCreateConversationFragment extends BaseHttpRecyclerFragment<ChatingRoom,ConversationView,ConversationAdapter>
        implements CacheCallBack<ChatingRoom> {

    private String[] selectStars = new String[3];
    private String userId;

    private HttpModel<EntityPageData> mMyConversationHttpModel;
     ...
     * @return
     */
    public static CrowdCreateConversationFragment createInstance() {

        return new CrowdCreateConversationFragment();
    }

    public CrowdCreateConversationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //聊天室列表
        mMyConversationHttpModel = new HttpModel<>(EntityPageData.class);
        conversationQuery();
    ...
    public void conversationQuery() {
        ...
        mMyConversationHttpModel.post(request, URL_BASE + URLConstant.CONVERSATIONQUERY,1,this);
    }
    ...
    public void Success(String url, int RequestCode, EntityBase entityBase) {
        ...
        switch (RequestCode) {
            case 1:
                EntityPageData.Content entityPageData = mMyConversationHttpModel.getData().getContent();
