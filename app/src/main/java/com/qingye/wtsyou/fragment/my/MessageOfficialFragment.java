...
public class MessageOfficialFragment extends BaseHttpRecyclerFragment<Message,MessageView,MessageAdapter> implements CacheCallBack<Message> {
     ...
     * @return
     */
    public static MessageOfficialFragment createInstance() {

        return new MessageOfficialFragment();
    }

    public MessageOfficialFragment() {
