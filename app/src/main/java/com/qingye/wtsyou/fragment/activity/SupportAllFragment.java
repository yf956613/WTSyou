 ...
 */
public class SupportAllFragment extends BaseHttpRecyclerFragment<Campaign,ActivityNewSupportView,ActivityNewSupportAdapter> implements CacheCallBack<Campaign> {
     ...
     * @return
     */
    public static SupportAllFragment createInstance() {

        return new SupportAllFragment();
    }

    public SupportAllFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Position = bundle.getInt(SupportAllFragment.ARGUMENT_POSITION);
