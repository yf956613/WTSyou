...
public class StarsMainShowFragment extends BaseHttpRecyclerFragment<Campaign,StarsMainShowView,StarsMainShowAdapter> implements CacheCallBack<Campaign> {
     ...
     * @return
     */
    public static StarsMainShowFragment createInstance() {

        return new StarsMainShowFragment();
    }

    public StarsMainShowFragment() {
    ...
    public void setList(final List<Campaign> list) {
        ...
        setList(new AdapterCallBack<StarsMainShowAdapter>() {

            @Override
            public StarsMainShowAdapter createAdapter() {
                return new StarsMainShowAdapter(context);
            }
