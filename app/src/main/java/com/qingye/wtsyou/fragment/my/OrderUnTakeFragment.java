...
public class OrderUnTakeFragment extends BaseHttpRecyclerFragment<OrderDetailed,OrderDetailedView,OrderDetailedAdapter> implements CacheCallBack<OrderDetailed> {
