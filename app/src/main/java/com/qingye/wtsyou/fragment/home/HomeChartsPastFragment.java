 ...
 */
public class HomeChartsPastFragment extends BaseHttpRecyclerFragment<Charts,HomeChartsPastView,HomeChartsPastAdapter> implements CacheCallBack<Charts> {
     ...
     * @return
     */
    public static HomeChartsPastFragment createInstance() {

        return new HomeChartsPastFragment();
    }

    public HomeChartsPastFragment() {
...
//类相关初始化，必须使用<<<<<<<<<<<<<<<<
        ...
        Position = bundle.getInt(HomeChartsPastFragment.ARGUMENT_POSITION);
