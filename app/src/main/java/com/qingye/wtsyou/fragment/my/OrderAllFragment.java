...
public class OrderAllFragment extends BaseHttpRecyclerFragment<OrderDetailed,OrderDetailedView,OrderDetailedAdapter> implements CacheCallBack<OrderDetailed> {
