 ...
 */
public class HomeChartsFragment extends BaseHttpListFragment<Charts,HomeChartsAdapter> implements CacheCallBack<Charts> {
     ...
     * @return
     */
    public static HomeChartsFragment createInstance() {

        return new HomeChartsFragment();
    }

    public HomeChartsFragment() {
...
//类相关初始化，必须使用<<<<<<<<<<<<<<<<
        ...
        Position = bundle.getInt(HomeChartsFragment.ARGUMENT_POSITION);
