 ...
 */
public class SupportIngFragment extends BaseHttpRecyclerFragment<Supports,ActivityNewSupportView,ActivityNewSupportAdapter> implements CacheCallBack<Supports> {
                            ...
                            if(!StringUtil.isEmpty(resultJson)){
                                ...
                                if(entityPageData.isSuccess()){
                                    ...
                                    for (Supports support : supports) {
                                        if (support.getState().equals("supporting")) {
