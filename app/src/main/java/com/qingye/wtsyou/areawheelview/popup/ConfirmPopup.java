package com.qingye.wtsyou.areawheelview.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int topLineColor = 0xFFFFFFFF;
    ...
    protected int cancelTextColor = 0xFFFE8360;
    protected int submitTextColor = 0xFFFE8360;
    protected int titleTextColor = Color.BLACK;
    protected int pressedTextColor = 0XFFFE8360;
