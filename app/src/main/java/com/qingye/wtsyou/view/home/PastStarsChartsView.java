...
public class PastStarsChartsView extends BaseView<RankInfos> implements View.OnClickListener {
    ...
    public PastStarsChartsView(Activity context, ViewGroup parent) {
    ...
    public void bindView(RankInfos data_){
        ...
        //人气值
        tvValue.setText("人气值   " + Integer.toString(data.getScore()));
