...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColorStart = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color_start, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        mIndicatorColorEnd = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_color_end, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
    ...
    public void setTabStringData(String[] titles) {
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            if (mIndicatorHeight > 0) {
                ...
                LinearGradient lg = new LinearGradient(0,0, getMeasuredWidth(), getMeasuredHeight(),mIndicatorColorStart,mIndicatorColorEnd, Shader.TileMode.MIRROR);
                mTrianglePaint.setShader(lg);
            ...
            if (mIndicatorHeight > 0) {
                ...
                mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.TL_BR,
                        new int[] { mIndicatorColorStart,mIndicatorColorEnd});
    ...
    public void setIndicatorColorStart(int indicatorColorStart) {
        this.mIndicatorColorStart = indicatorColorStart;
        invalidate();
    }

    public void setIndicatorColorEnd(int mIndicatorColorEnd) {
        this.mIndicatorColorEnd = mIndicatorColorEnd;
        invalidate();
    }
    ...
    public int getIndicatorColorStart() {
        return mIndicatorColorStart;
    }

    public int getIndicatorColorEnd() {
        return mIndicatorColorEnd;
    }
