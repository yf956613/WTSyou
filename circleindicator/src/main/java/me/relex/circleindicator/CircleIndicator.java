...
public class CircleIndicator extends LinearLayout {
    ...
    private final static int DEFAULT_INDICATOR_HEIGTH = 5;
    private final static int DEFAULT_INDICATOR_MARGIN = 4;
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorHeight =
                (mIndicatorHeight < 0) ? dip2px(DEFAULT_INDICATOR_HEIGTH) : mIndicatorHeight;
        mIndicatorMargin =
