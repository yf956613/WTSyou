...
import wzp.demo.imageloop.animation.AbsAnimation;
import wzp.demo.imageloop.animation.AnimationType;
import wzp.demo.imageloop.animation.ColorAnimation;
import wzp.demo.imageloop.animation.FillAnimation;
import wzp.demo.imageloop.animation.ScaleAnimation;
import wzp.demo.imageloop.animation.ValueAnimation;
import wzp.demo.imageloop.util.DensityUtils;


public class PageIndicatorView extends View implements ViewPager.OnPageChangeListener {

    private static final int DEFAULT_CIRCLES_COUNT = 4;
    ...
    protected void onAttachedToWindow() {
        ...
        Log.d("PageIndicator", "onAttachedToWindow");
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Log.d("PageIndicator", "onDetachedFromWindow");
    }
    ...
    /**
     * backwhite number of circle indicators
     */
    public int getCount() {
        return count;
    }
    ...
    /**
     * backwhite radius of each circle indicators in px. If custom radius is not set, return
    ...
    /**
     * backwhite padding in px between each circle indicator. If custom padding is not set,
    ...
    /**
     * backwhite stroke width in px. If custom stroke width is not set and {@link AnimationType#FILL} is selected.
     */
    ...
    /**
     * backwhite color of unselected state of each circle indicator. If custom unselected color
    ...
    /**
     * backwhite color of selected circle indicator. If custom unselected color.
    ...
    /**
     * backwhite animation duration time in milliseconds. If custom duration is not set,
    ...
    /**
     * backwhite position of currently selected circle indicator.
     */
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        Log.d("PageIndicator", "" + visibility);
        if (visibility == VISIBLE) {
            Log.d("PageIndicator", "VISIBLE");
        } else {
            Log.d("PageIndicator", "GONE");
        }
    }
}
